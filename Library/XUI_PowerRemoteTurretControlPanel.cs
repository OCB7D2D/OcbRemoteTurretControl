...
public class XUI_PowerRemoteTurretPanel : XUiC_PowerRangedTrapWindowGroup
{
    ...
    public IEnumerator DebugTick()
    {
        while(true)
        {
            //Log.Out("Debug CurrentBlock {0}, CurentPanel {1}, CurrentTurretSlot {2}, LastSlotLocked {3}",
            //    CurrentBlock, CurrentPanel, CurrentTurretSlot, LastSlotLocked);
    ...
    public override void OnOpen()
    {
        ...
        if (RemoteTurrets == null || RemoteTurrets.Count == 0)
        {
            ...
            Log.Warning("Closing the window directly again");
            return;
        }
    ...
    public void ShowRemoteSlot(int slot, bool first)
    {
        ...
        else if (CurrentBlock.LockSingleTurret)
        {
            ...
            if (ConnectionManager.Instance.IsServer)
            {
                ...
                Log.Out("CLose now again 2 {0}", TileEntity);
                // TileEntity = null;
            ...
            else
            {
                ...
                NetServerAction.RemoteServerCall(fqfn, new object[] {
                    ...
                    (rv) => { // Success
                        ...
                        {
                            Log.Out("Try next fucking thing");
